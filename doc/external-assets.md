...
The manifest format is simple enough that an AI assistant like Codex can generate them for you — just describe your sprites or share the PNGs and ask it to write the manifests.
